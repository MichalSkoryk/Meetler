...
class FlywayMigrationIntegrationTest extends AbstractIntegrationTest {
  ...
  void migrationsCreateExpectedCoreTables() {
    ...
    assertThat(successfulMigrations).isGreaterThanOrEqualTo(23);
    ...
    assertThat(tableExists("billing_customer")).isTrue();
    assertThat(tableExists("billing_entitlement")).isTrue();
    assertThat(tableExists("billing_webhook_event")).isTrue();
  }
